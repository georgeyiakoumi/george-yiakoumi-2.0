...
export function RichTextBlock({ block }: RichTextBlockProps) {
  ...
  return (
    <div className={`mx-auto w-full md:max-w-lg lg:max-w-2xl xl:max-w-4xl 2xl:max-w-6xl px-8 lg:px-0 first:mt-0 ${startsWithH2 ? ' mt-16 pt-16 border-border border-t first:border-none' : ''}`}>
