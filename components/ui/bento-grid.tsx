...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[22rem] grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4",
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    ...
    <div className="p-4 flex flex-col justify-start items-start">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-3 transition-all duration-300">
